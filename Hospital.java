...
import java.text.*;
public class Hospital  extends JFrame  implements ActionListener,KeyListener
{
    ...
    Hospital()
    {
            //super("new Hospital",true,true,true,true);
        ...
        l9.setForeground(Color.green);
                      ...
                      l0=new JLabel("*** HOSPITAL DETAILS***");
	...
	cc.setBounds(490,375,200,30);
 	...
 	l10=new JLabel ("Emergency Contact Number");
	...
	l5=new JLabel ("Official Email Id");
...
public void actionPerformed(ActionEvent ae) 
   {
	...
	if(ae.getSource()==b2)
	{
			...
			cn1();
		                 String s="insert into Hospital values('" + t1.getText()  + "','" + t2.getText() + "','" + t3.getText() + "','" + (String) cc.getSelectedItem() + "'," + t4.getText()  + ",'" + t5.getText() + "')";
