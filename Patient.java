...
import java.text.*;
public class Patient  extends JFrame  implements ActionListener,KeyListener
{
...
public void actionPerformed(ActionEvent ae) 
   {
	...
	if(ae.getSource()==b2)
	{
			...
			cn1();
		                 String s="insert into Patient values('" + t1.getText()  + "','" + t2.getText() + "','" + t3.getText() + "','" + (String) cc.getSelectedItem() + "'," + t4.getText()  + ",'" + t5.getText() + "')";
