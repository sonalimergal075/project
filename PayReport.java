...
import javax.swing.JInternalFrame ;
public class PayReport  extends JFrame implements ActionListener
{
...
DateFormat d=new SimpleDateFormat ("dd/MM/yyyy");
 ...
 add(l); 
  ...
  try{
			...
			rs.close(); 
			String record1[][]=new String[cnt][11];
			...
			while(rs.next())
			{
				...
				record1[i][7]=rs.getString(8);
                                                                             record1[i][8]=rs.getString(9);
                                                                             record1[i][9]=rs.getString(10);
