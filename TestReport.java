...
{
    String h[]={"Test Id","Test Name","Price","Quantity"};
		int cnt=0,i=0;
		JLabel l1,l,z,z1;
		JScrollPane jpane;
		JTable t1;
...
public TestReport()
		{
//super("ProductReport",true,true,true,true);
	Connection con;
...
l5=new JLabel ("Time");
 ...
 t2.setText(d.format(date));
            ...
            l1=new JLabel("Testt Information");
...
z1=new JLabel(new ImageIcon("God/cc.jpg"));
add(z1);
z1.setBounds(-30,-200,500,500); 
		z=new JLabel(new ImageIcon("img/ii.jpg"));
add(z);
